                ...
                <table style="font-size:10px;" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				  ...
				  @foreach($spk_dev as $spk_dev)
					<tr>
						...
						<?php
							$anggaran=DB::table('jenis_anggaran')->where('id',$spk_dev->jenis_anggaran)->get()->first();
						?>
						...
						<td>
							...
							<tr>
								<td style="border: 0px;">
									...
									<form id="edit{{$no}}" style="display:none; float:left; margin-right:5px;" action="<?php echo url('/spk_dev_delete'); ?>" method="post">
										<input type="hidden" name="_token" value="{{csrf_token()}}">
								...
								<td style="border: 0px;">
									...
									<form style="display:none;" id="popay{{$no}}" action="<?php echo url('/popaylist'); ?>" method="post">
										<input type="hidden" name="_token" value="{{csrf_token()}}">
										<input type="hidden" name="id_spk_dev" value="{{$spk_dev->id}}">
