					...
					<form id="dbln{{$no}}" action="<?php echo url('/lihat_dokumen_pekerjaan'); ?>" method="post">
					  ...
					  <td>
						<table>
							...
							<form id="spk_dev{{$no}}" style="display:none; float:left; margin-right:5px;" action="<?php echo url('/spk_dev'); ?>" method="post">
								<input type="hidden" name="_token" value="{{csrf_token()}}">
								<input type="hidden" name="id_laporan_pekerjaan" value="{{$id_laporan_pekerjaan}}">
								<input type="hidden" name="id" value="{{$pkn->id}}">
							...
							<form id="edit{{$no}}" style="display:none; float:left; margin-right:5px;" action="<?php echo url('/edit_dokumen_pekerjaan'); ?>" method="post">
								<input type="hidden" name="_token" value="{{csrf_token()}}">
								<input type="hidden" name="id_laporan_pekerjaan" value="{{$id_laporan_pekerjaan}}">
								<input type="hidden" name="id" value="{{$pkn->id}}">
								<button type="submit" class="btn btn-primary">Edit</button></a>
							...
							<form style="display:none;" id="hapus{{$no}}" method="post" action="<?php echo url('/hapus_dokumen_pekerjaan'); ?>">
								<input type="hidden" name="_token" value="{{csrf_token()}}">
								<input type="hidden" name="id" value="{{$pkn->id}}">
