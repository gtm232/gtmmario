	...
	<!-- ============================================================== -->
            ...
            <div class="card-body ">
              ...
              <div class="table-responsive" style="margin:10px;">
				...
				<form style="margin:10px 0px 10px 0px;" action="<?php echo url('/popay_pagu'); ?>" method="post">
            ...
            @endif
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
				  <?php $no=1; 
				  $popaylist=DB::table('popay_pagu')->where('id_spk_dev',$id_spk_dev)->get();
				  ?>
				  @foreach($popaylist as $popaylist)
                    ...
                    <tr>
					  ...
					  <td>
							...
							<form id="hapus{{$no}}" style="display:none; float:left; margin-right:5px;" action="<?php echo url('/popay_hapus_pagu'); ?>" method="post">
								<input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<form id="popay{{$no}}" style="display:none; float:left;" action="<?php echo url('/popay_paid_pagu'); ?>" method="post">
								<input type="hidden" name="_token" value="{{csrf_token()}}">
								<input type="hidden" name="id" value="{{$popaylist->id}}">
								<input type="hidden" name="harga" value="{{$harga}}">
								<input type="hidden" name="id_spk_dev" value="{{$id_spk_dev}}">
